...
📋 How It Works
Extract: Upload a PDF → text is extracted using PyPDF2/pdfplumber
Identify: Regex patterns detect claims (stats, $, dates, technical figures)
Verify: Each claim is searched via DuckDuckGo API
Report: Results are categorized with confidence scores
